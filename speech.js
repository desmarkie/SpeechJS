/**
  ...
  After a few minutes of running it can generates a 'network' error that also causes the api to stop responding. The only fix for that I could find was to recreate the SpeechRecogniton completely, so I dropped in the restartCallback to allow handling of this.
